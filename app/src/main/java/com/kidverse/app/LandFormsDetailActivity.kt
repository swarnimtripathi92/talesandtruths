...
class LandFormsDetailActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_landforms_detail)

        tts = TextToSpeech(this, this)

        val landformId = intent.getStringExtra("landformId") ?: return
        ...
        FirebaseFirestore.getInstance()
            ...
            .addOnSuccessListener { doc ->
                ...
                val imageName = doc.getString("image") ?: "gk_mountains1"
                val resId = resources.getIdentifier(imageName, "drawable", packageName)
                if (resId != 0) imgHeader.setImageResource(resId)

                val factsRaw =
                    doc.get("facts") as? List<Map<String, String>> ?: emptyList()
