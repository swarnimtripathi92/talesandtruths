...
class OceanDetailActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val oceanId = intent.getStringExtra("oceanId") ?: return
        ...
        FirebaseFirestore.getInstance()
            ...
            .addOnSuccessListener { doc ->
                ...
                val imageName = doc.getString("image") ?: "gk_pacific"
                val resId = resources.getIdentifier(imageName, "drawable", packageName)
                if (resId != 0) imgHeader.setImageResource(resId)

                val factsRaw = doc.get("facts") as? List<Map<String, String>> ?: emptyList()
